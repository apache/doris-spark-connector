...
public final class DorisHttpClientFactory {
    ...
    public static HttpClientBuilder configure(
            HttpClientBuilder builder, DorisTlsOptions options) {
        builder.setRedirectStrategy(new DorisRedirectStrategy(options));
    ...
    public static HttpURLConnection openConnection(URL url, DorisTlsOptions options)
        ...
        HostnameVerifier hostnameVerifier = options.isSkipHostnameVerification()
