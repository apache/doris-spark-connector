...
public final class DorisRedirectStrategy extends DefaultRedirectStrategy {
    ...
    public URI getLocationURI(HttpRequest request, HttpResponse response, HttpContext context)
        ...
        if (tlsOptions.isEnabledFor(DorisTlsOptions.Protocol.HTTP)
            ...
            String sourceScheme = source.getScheme() == null && sourceHost != null
                    ? sourceHost.getSchemeName()
                    : source.getScheme();
            String sourceDescription = source.isAbsolute() || sourceHost == null
                    ? source.toString()
